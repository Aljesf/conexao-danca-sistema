...
export function DevedoresTable({
  ...
  subtitle = "Lista sempre baseada em titulos vencidos com saldo em aberto.",
  emptyMessage = "Nenhum devedor vencido encontrado nos filtros atuais.",
}: Props) {
        ...
        <table className="min-w-full text-sm">
          <thead>
            <tr className="border-b border-slate-100 text-left text-xs uppercase tracking-wide text-slate-500">
              ...
              <th className="px-3 py-3 font-medium">Titulos vencidos</th>
