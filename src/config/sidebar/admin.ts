...
export const adminSidebar: SidebarSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "?? Lançamentos manuais", href: "/admin/financeiro/lancamentos-manuais" },
    ],
  },
  {
    id: "admin-cartoes",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "?? Configurações", href: "/admin/financeiro/credito-conexao/configuracoes" },
    ],
  },
  {
    id: "admin-loja-admin",
    ...
    items: [
      ...
      { label: "?? Configurações do produto", href: "/admin/loja/cadastros" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { label: "??? Configuração da loja", href: "/admin/config/loja" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "??? Espaços", href: "/admin/configuracoes/espacos" },
      { label: "?? Tabelas de preços (Escola)", href: "/admin/escola/configuracoes/matriculas/tabelas" },
      { label: "?? Planos de pagamento (matrícula)", href: "/admin/escola/configuracoes/matriculas/planos-pagamento" },
    ],
  },
  {
    id: "admin-auditoria",
