...
export default function AdminCafeComprasPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <PageHeader
        title="Ballet Cafe (Admin) — Compras de insumos"
        description="Registre compras por valor total (R$) e quantidade. O sistema calcula o custo unitario e abastece o estoque."
      />
