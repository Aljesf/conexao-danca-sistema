...
export default function EmitirDocumentosClient(props: { matriculaId: number }) {
  const { matriculaId } = props;
      ...
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            {message && (
              <div className="mt-4 rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm">{message}</div>
            )}
          </CardContent>
        </Card>
