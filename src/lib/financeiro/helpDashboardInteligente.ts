export const HELP_DASHBOARD_INTELIGENTE = `Help — Diretor Inteligente (Bloco 2)
...
- Mantenha a constante de renderização em src/lib/financeiro/helpDashboardInteligente.ts alinhada com o conteúdo oficial.
