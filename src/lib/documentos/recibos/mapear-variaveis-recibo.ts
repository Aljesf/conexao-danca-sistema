...
export type VariaveisReciboAgrupadas = {
  pessoa: VariaveisReciboDocumento;
  financeiras: VariaveisReciboDocumento;
  institucionais: VariaveisReciboDocumento;
  documentais: VariaveisReciboDocumento;
};
...
export function mapearVariaveisReciboAgrupadas(
  snapshot: ReciboPagamentoSnapshot,
  extras?: {
    escola_nome?: string | null;
    cidade_data?: string | null;
  },
): VariaveisReciboAgrupadas {
...
export function mapearVariaveisRecibo(
  ...
  const grupos = mapearVariaveisReciboAgrupadas(snapshot, extras);
