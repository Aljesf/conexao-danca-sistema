...
- 2026-03-10 — Documentos / Autoria / Modelos: primeira rodada de implementacao da nova UX entregue. A listagem principal de modelos passou a destacar nome, tipo documental, status, versao, formato e retomada rapida de edicao em cards administrativos. A criacao inicial foi simplificada para identidade, documento vinculado e corpo do texto, com configuracoes avancadas recolhidas. A edicao do modelo virou um fluxo guiado em 7 etapas: identidade, operacao documental, estrutura reutilizavel, corpo, variaveis e colecoes, preview e ativacao/versionamento. Nesta rodada nao houve mudanca estrutural de SQL nem de backend; o foco ficou em paginas/componentes da experiencia de modelos. Pendencias seguintes da frente de autoria: revisar visualmente o fluxo novo, capturar prints da navegacao por etapas e depois atacar ergonomia das telas auxiliares de variaveis, colecoes e conjuntos.
