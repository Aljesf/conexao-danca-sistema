...
## Problema original
- O sistema gerava cobrancas paralelas para mensalidades da Conta Interna: uma no fluxo de matricula e outra no fluxo canonico da fatura.
...
## Correcao aplicada
- A matricula deixou de gerar cobranca paralela para mensalidade da Conta Interna.
...
## Situacao final
- A correcao estrutural da Conta Interna esta concluida.
...
- Revisar fluxos legados ainda fora do escopo que possam consultar ou depender de `cobranca_id` legado na Conta Interna.
