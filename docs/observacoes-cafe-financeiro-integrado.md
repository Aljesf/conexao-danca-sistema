...
- Aluno identificado pode consumir no ato ou seguir para conta interna do aluno quando houver responsavel financeiro ou conta elegivel.
- Colaborador identificado pode consumir no ato ou seguir para conta interna do colaborador para fechamento futuro.

## 2. Pagamento imediato vs conta interna

- Pagamento imediato gera recebimento e movimento financeiro do Ballet Cafe.
- Conta interna do aluno nao gera recebimento imediato; gera cobranca canonica por competencia, integra a fatura mensal e segue depois para cobranca NeoFin.
- Conta interna do colaborador nao gera recebimento imediato; o consumo fica reservado para fechamento futuro em fatura e folha.
...
- Consumos em conta interna continuam economicamente atribuidos ao Ballet Cafe, mesmo com liquidacao posterior.
